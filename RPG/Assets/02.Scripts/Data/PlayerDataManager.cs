...
public class PlayerDataManager 
{
    ...
    public static string dirPath; // 플레이어 데이터를 저장할 디렉토리 경로, 생성자 호출전에 참조하면 안됨.
    ...
    {
        dirPath = $"{Application.persistentDataPath}/PlayerData"; // Application.persistentDataPath 는 운영체제마다 다름.
    }
    ...
    public static PlayerData CreateData(string nickName)
    {
        ...
        System.IO.File.WriteAllText(jsonPath, jsonData); // Serialize 된 플레이어 데이터를 파일 경로에다가 파일쓰기
    ...
    public static void SaveData()
    {
        ...
        string jsonData = JsonUtility.ToJson(_data); // 플레이어 데이터 Serialize 해서 json포맷의 문자열로 변환
