...
public class MapSpawner : MonoBehaviour
{
    ...
    [SerializeField] Transform endOfInitMap;
    private float distance;*/

    [SerializeField] LinkedList<Transform> spawnedMapTiles = new LinkedList<Transform>(); //LinkedList node를 가지고 있는 자료구조

    public static void RemeveFirstAndSpawnNew()
    {
