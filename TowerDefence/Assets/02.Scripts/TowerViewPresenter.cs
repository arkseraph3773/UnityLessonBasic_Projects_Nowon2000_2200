...
public class TowerViewPresenter : MonoBehaviour
{
    ...
    private void Update()
    {
        if (selectedTowerHandler != null)
        {
            ...
            RaycastHit[] hits = Physics.RaycastAll(ray,float.PositiveInfinity, nodeLayer).OrderBy(h => h.transform.position.y).ToArray();
    ...
    public Transform GetTowerPreviewObjectTransform()
    {
